...
def main():
    ...
    model_name = args.model_name.split('/')[-1] if args.model_name != 'Qwen/Qwen3-0.6B-Base' else 'dpo_model'
    model_repo = f"{args.hf_username}/{model_name}_{config_name}_{dataset_name}"
